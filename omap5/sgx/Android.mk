...
prebuilt_sgx_vendor_bins := \
	bin/texture_benchmark \
	bin/sgx_flip_test_SGX544_105 \
	bin/hal_client_test \
	bin/sgx_init_test_SGX544_105 \
	bin/hal_server_test \
	bin/services_test_SGX544_105 \
	bin/sgx_render_flip_test_SGX544_105 \
	bin/testwrap \
...
include $(CLEAR_VARS)
LOCAL_MODULE := ti_omap5_sgx_libs
LOCAL_MODULE_TAGS := optional
